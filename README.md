# Benchmark (32blit)
A Simple Sprite blitting test

## Controls

| Button | Action                                                                   |
|--------|--------------------------------------------------------------------------|
| DPAD LEFT | Decrease sprites with 1 |
| DPAD RIGHT | Increase sprites with 1 |
| DPAD UP | Increase sprites with 10 |
| DPAD DOWN | Decrease sprites with 10 |
| BUTTON X | Increase sprites with 25 |
| BUTTON Y | Decrease sprites with 25 |
| BUTTON A | Next Draw Mode |
| BUTTON B | Previous Draw Mode |
